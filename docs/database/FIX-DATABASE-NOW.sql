...
-- This fixes ALL issues: 406 errors, missing users table, RLS policies, triggers
...
-- Step 3: Create sequence for position if it doesn't exist
DO $$ 
BEGIN
...
BEGIN
    ...
    VALUES (
        ...
        COALESCE(NEW.raw_user_meta_data->>'referralCode', substr(md5(random()::text), 1, 8)),
...
-- Step 10: Create referral_tracking table
...
-- Step 11: Sync existing auth users who don't have profiles
