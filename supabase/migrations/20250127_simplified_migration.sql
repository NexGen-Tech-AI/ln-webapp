-- =====================================================
-- FIX MIGRATION - Simplified without pgcrypto issues
-- =====================================================
-- This migration fixes the database without using pgcrypto functions
-- =====================================================
...
BEGIN
    ...
    -- For now, store encrypted fields as plain text
    -- We'll implement proper encryption separately
    UPDATE public.users
    SET 
        email_encrypted = email,
        profession_encrypted = profession,
    ...
    IF reward_config IS NOT NULL THEN
        ...
        IF completed_batches > last_credit_batch THEN
            ...
            SELECT
                ...
                COALESCE(AVG(rt.subscription_amount), 20),
...
-- For now, copy plain text to encrypted fields
UPDATE public.users
SET 
    email_encrypted = COALESCE(email_encrypted, email),
    profession_encrypted = COALESCE(profession_encrypted, profession),
    company_encrypted = COALESCE(company_encrypted, company)
...
-- =====================================================
-- MIGRATION COMPLETE - Simplified without encryption
-- =====================================================