-- =====================================================
-- COMPREHENSIVE LIFENAVIGATOR DATABASE MIGRATION (FIXED)
-- =====================================================
...
DROP POLICY IF EXISTS "Users can view own non-sensitive data" ON public.users;
...
DROP POLICY IF EXISTS "Users view referral tracking with verification" ON public.referral_tracking;
DROP POLICY IF EXISTS "Service role bypass" ON public.referral_tracking;
...
DROP POLICY IF EXISTS "Anyone can view reward structure" ON public.referral_rewards;
DROP POLICY IF EXISTS "Service role bypass" ON public.referral_rewards;
...
DROP POLICY IF EXISTS "Users view own credits with verification" ON public.referral_credits;
DROP POLICY IF EXISTS "Service role bypass" ON public.referral_credits;
...
DROP POLICY IF EXISTS "Authenticated users can insert analytics" ON public.page_views;
DROP POLICY IF EXISTS "Service role bypass" ON public.page_views;
...
DROP POLICY IF EXISTS "Authenticated users can insert analytics" ON public.form_analytics;
DROP POLICY IF EXISTS "Service role bypass" ON public.form_analytics;
...
DROP POLICY IF EXISTS "Authenticated users can insert analytics" ON public.click_events;
DROP POLICY IF EXISTS "Service role bypass" ON public.click_events;
...
DROP POLICY IF EXISTS "Service role bypass" ON public.admin_users;
...
DROP POLICY IF EXISTS "Service role bypass" ON public.oauth_connections;
...
DROP POLICY IF EXISTS "Service role bypass" ON public.notification_preferences;
...
DROP POLICY IF EXISTS "Service role only" ON public.security_config;
...
DROP POLICY IF EXISTS "Service role only" ON public.security_audit_log;
...
COMMENT ON FUNCTION increment_referral_count IS 'Increments user referral count - for backend use';
